...
namespace UI {
    ...
    public class Joystick : PlayerInput {
        ...
        internal void TouchMoveControl(){
            ...
            Vector2 radiusPositive = new Vector2(pos.x + _playerInput._gamePadRadius, pos.y + _playerInput._gamePadRadius);
            Vector2 radiusNegative = new Vector2(pos.x - _playerInput._gamePadRadius, pos.y - _playerInput._gamePadRadius);
            ...
            if (Input.GetMouseButton(0)) {
                ...
                if (mousePos.x < radiusPositive.x && mousePos.y < radiusPositive.y && mousePos.x > radiusNegative.x &&
                    ...
                    _playerInput._movement.touchInput = gamepadTouch.normalized;
